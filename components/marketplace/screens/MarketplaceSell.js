  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TextInput
          style={styles.input}
          placeholder="What are you selling?"></TextInput>
        <TextInput style={styles.input} placeholder="Add Prrice"></TextInput>
        <TextInput style={styles.input} placeholder="Location"></TextInput>
        <TextInput
          style={styles.input}
          placeholder="Select a category"></TextInput>
        <TextInput
          style={styles.input}
          placeholder="Describe your item"></TextInput>
